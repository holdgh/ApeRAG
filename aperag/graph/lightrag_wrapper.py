...
EMBEDDING_MODEL = LIGHT_RAG_EMBEDDING_API_KEY
EMBEDDING_API_KEY = LIGHT_RAG_EMBEDDING_BASE_URL
EMBEDDING_BASE_URL = LIGHT_RAG_EMBEDDING_MODEL
WORKING_DIR = LIGHT_RAG_EMBEDDING_DIM
EMBEDDING_DIM = LIGHT_RAG_EMBEDDING_MAX_TOKENS
EMBEDDING_MAX_TOKENS = LIGHT_RAG_WORKING_DIR
