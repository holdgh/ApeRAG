...
from aperag.db.models import Chat, Collection, CollectionSyncHistory, Document, Invitation, User

# NOTE: If UserAdmin is imported, it must be imported after User is registered, otherwise start app will fail
...
class CollectionAdmin(admin.ModelAdmin):
    ...
    def created_date(self, obj):
        return format_html('<span style="color: black;">{}</span>', obj.gmt_updated.strftime("%Y-%m-%d %H:%M:%S"))
