...
#   timestamp: 2025-05-25T07:08:31+00:00
...
class SchemaProperty(BaseModel):
    ...
    description: Optional[str] = None
    default: Optional[Union[str, float, bool, dict[str, Any], list]] = None
    ...
    items: Optional[Union[SchemaProperty, Items]] = None
    properties: Optional[dict[str, SchemaProperty]] = None
    additionalProperties: Optional[Union[bool, SchemaProperty]] = None
...
class Node(BaseModel):
    ...
    type: str = Field(..., description='Type of node', example='vector_search')
    title: str = Field(
        ..., description='Human-readable title of the node', example='Vector Search'
    )
    data: Data
