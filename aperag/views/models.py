...
#   timestamp: 2025-05-07T05:46:24+00:00
...
class ModelSpec(BaseModel):
    model: Optional[str] = Field(
        None, description='The name of the language model to use'
    )
    ...
    timeout: Optional[confloat(ge=1.0)] = Field(
...
class SupportedModelServiceProvider(BaseModel):
    name: Optional[str] = None
...
class SupportedModelServiceProviderList(BaseModel):
    items: Optional[list[SupportedModelServiceProvider]] = None
    pageResult: Optional[PageResult] = None
