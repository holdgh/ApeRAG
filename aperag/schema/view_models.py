...
#   timestamp: 2025-06-12T06:54:14+00:00
...
class ModelSpec(BaseModel):
    ...
    tags: Optional[list[str]] = Field(
        None, description='Tags for model categorization', example=['free', 'recommend']
    )
...
class SearchTestRequest(BaseModel):
    query: Optional[str] = Field(None, description='The user input query')
    vector_search: Optional[VectorSearchParams] = None
    fulltext_search: Optional[FulltextSearchParams] = None
    graph_search: Optional[GraphSearchParams] = None
...
class LlmProviderList(BaseModel):
    items: Optional[list[LlmProvider]] = None
    pageResult: Optional[PageResult] = None


class LlmProviderCreate(BaseModel):
    name: str = Field(..., description='Unique provider name identifier')
