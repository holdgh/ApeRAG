...
#   timestamp: 2025-05-28T08:38:34+00:00
...
class Node(BaseModel):
    ...
    type: Literal[
        'start', 'vector_search', 'keyword_search', 'merge', 'rerank', 'llm'
...
class EdgeType(BaseModel):
    __root__: Literal['straight', 'step', 'smoothstep', 'default', 'simplebezier']
...
class Edge(BaseModel):
    ...
    type: Optional[EdgeType] = Field(
        None, description='Type of the edge', example='edge'
    )
...
class WorkflowStyle(BaseModel):
    ...
    edgeType: Optional[EdgeType] = None
