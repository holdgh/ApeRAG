...
#   timestamp: 2025-09-04T09:27:27+00:00
...
class BotType(RootModel[Literal['knowledge', 'common', 'agent']]):
    root: Literal['knowledge', 'common', 'agent'] = Field(
        ..., description='The type of bot', examples=['knowledge']
    )
