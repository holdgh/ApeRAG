...
async def test_openai_chat_completions():
    ...
    client = OpenAI(base_url="http://localhost:8000/v1", api_key="sk-3b26ff8792444d65a7075a31dd0c438a")
...
async def test_openai_chat_completions_error_handling():
    ...
    try:
        client.chat.completions.create(
            model="aperag", messages=[{"role": "user", "content": "Hello"}], stream=False, bot_id="invalid_bot_id"
        )
