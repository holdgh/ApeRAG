...
from deeprag.auth.validator import FeishuEventVerification
...
from deeprag.db.ops import query_bot, query_chat_by_peer
from deeprag.pipeline.knowledge_pipeline import KnowledgePipeline
from deeprag.source.feishu.feishu import FeishuClient
from deeprag.utils.utils import AESCipher
from deeprag.views.utils import fail, success
...
async def feishu_response_card_update(user, bot_id, data):
    ...
    await deeprag.chat.message.feedback_message(user, chat_id, msg_id, upvote, downvote, "")
