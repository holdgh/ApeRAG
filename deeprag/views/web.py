...
from deeprag.db.ops import build_pq, query_bot, query_web_chat, query_web_chats
from deeprag.views.main import MessageFeedbackIn
from deeprag.views.utils import fail, query_chat_messages, success
...
async def feedback_message(request, bot_id, chat_id, message_id, msg_in: MessageFeedbackIn):
    ...
    await deeprag.chat.message.feedback_message(chat.user, chat_id, message_id, msg_in.upvote, msg_in.downvote)
    return success({})
