...
from deeprag.context.full_text import insert_document, remove_document
...
from deeprag.readers.base_embedding import get_collection_embedding_model
from deeprag.readers.base_readers import DEFAULT_FILE_READER_CLS, SUPPORTED_COMPRESSED_EXTENSIONS
from deeprag.readers.local_path_embedding import LocalPathEmbedding
from deeprag.readers.qa_embedding import QAEmbedding
from deeprag.readers.question_embedding import QuestionEmbedding, QuestionEmbeddingWithoutDocument
from deeprag.source.base import get_source
from deeprag.source.feishu.client import FeishuNoPermission, FeishuPermissionDenied
from deeprag.utils.utils import (
...
def uncompress_file(document: Document):
    ...
    tmp_dir = Path(os.path.join('/tmp/deeprag', document.collection.id, document.name))
    try:
