...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name="bot",
            name="collections",
            field=models.ManyToManyField(to="deeprag.collection"),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "chat",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="deeprag.chat"
                    ),
                ),
                (
                    "collection",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(upload_to=deeprag.db.models.upload_document_path),
                ),
