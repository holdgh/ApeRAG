...
`,
  ...
  'document.detail.title': 'Document Details',
  'document.detail.loading': 'Loading document content...',
  'document.detail.fetch.failed': 'Failed to fetch document details',
  'document.detail.original.content': 'Original Content',
  'document.detail.chunks': 'Chunked Content',
  'document.detail.no.content': 'No content',
  'document.detail.content.unavailable': 'Original content unavailable',
  'document.detail.chunks.empty': 'No chunks available',
  'document.chunk.index': 'Chunk {index}',
