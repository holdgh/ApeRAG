...
`,
  ...
  'searchTest.test': '测试',
  'searchTest.vectorSearch': '向量检索',
  'searchTest.fulltextSearch': '全文检索',
  'searchTest.hybridSearch': '混合检索',
  'searchTest.topK': 'TopK',
  'searchTest.similarityThreshold': '相似度阈值',
  'searchTest.vectorTopK': '向量TopK',
  'searchTest.vectorSimilarity': '向量相似度',
  'searchTest.fulltextTopK': '全文TopK',
  'searchTest.searchResults': '检索结果',
  'searchTest.rank': '排序',
  'searchTest.content': '内容',
  'searchTest.score': '得分',
  'searchTest.source': '来源',
  'searchTest.history': '历史记录',
  'searchTest.question': '问题',
  'searchTest.time': '时间',
  'searchTest.action': '操作',
  'searchTest.details': '详情',
  'searchTest.delete': '删除',
  'searchTest.cancel': '取消',
  'searchTest.confirmDeleteHistory': '确定要删除这条历史记录吗？',
  'searchTest.deleteSuccess': '删除成功',
  'searchTest.deleteFailed': '删除失败',
  'searchTest.searchFailed': '搜索失败',
  'searchTest.historyQueryDetails': '历史查询详情',
  'searchTest.searchType': '检索方式',
  'searchTest.vectorSearchParams': '向量检索参数',
  'searchTest.fulltextSearchParams': '全文检索参数',
