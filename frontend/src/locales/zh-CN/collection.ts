export const collection = {
  ...
  'collection.sensitive.protect.method.required': '请选择保护策略',
  'collection.sensitive.help': '是否开启都不会影响已上传文档的保护状态',
  'collection.sensitive.nostore': '发现敏感信息告警且移除',
  'collection.sensitive.replace': '将敏感信息替换成 "*"',
  ...
  'collection.lightrag_model_not_found': '请在设置 -> 模型服务商中设置API Key',
