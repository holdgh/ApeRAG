export const settings = {
  ...
  'settings.mineru_api_token.test.not_set': 'Token 未设置',
  'settings.mineru_api_token.test.error': '测试请求失败',
  'settings.mineru_api_token.test.fetch_error': '网络请求错误',
  'settings.mineru_api_token.test.btn': '检查 Token',
  'settings.mineru_api_token.required': '请输入API Token',
  'settings.use_mineru.tooltip':
    '启用后，系统将优先使用 MinerU API 进行文档解析，以提升解析的质量与速度。',
};
