...
class InternLMChatAdapter(BaseChatAdpter):
    """Model chat Adapter for internlm-chat-7b"""

    def match(self, model_path: str):
        return "internlm-chat-7b" in model_path

    def get_generate_stream_func(self):
        from models.llm_out.intern_llm import intern_lm_generate_stream
        return intern_lm_generate_stream
...
class ChatGLMChatAdapter(BaseChatAdpter):
    ...
    def get_generate_stream_func(self):
        from models.llm_out.chatglm_llm import chatglm_generate_stream
...
class GuanacoChatAdapter(BaseChatAdpter):
    ...
    def get_generate_stream_func(self):
        from models.llm_out.guanaco_llm import guanaco_generate_stream
...
class FalconChatAdapter(BaseChatAdpter):
    ...
    def get_generate_stream_func(self):
        from models.llm_out.falcon_llm import falcon_generate_output
...
class ProxyllmChatAdapter(BaseChatAdpter):
    ...
    def get_generate_stream_func(self):
        from models.llm_out.proxy_llm import proxyllm_generate_stream
...
class GorillaChatAdapter(BaseChatAdpter):
    ...
    def get_generate_stream_func(self):
        from models.llm_out.gorilla_llm import generate_stream
...
class GPT4AllChatAdapter(BaseChatAdpter):
    ...
    def get_generate_stream_func(self):
        from models.llm_out.gpt4all_llm import gpt4all_generate_stream
